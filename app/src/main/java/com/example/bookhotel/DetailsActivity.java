...
//    public void MpesaApi(View view) {
...
//        new HttpPost();
        //URL link = new URL("https://tinybitdaraja.herokuapp.com/msp");
//        URL link = new URL("http://localhost:3600/msp");
//        HttpURLConnection openConnection = (HttpURLConnection) link.openConnection();
//        openConnection.setRequestMethod("POST");
//        openConnection.setRequestProperty("Content-Type" , "application/json");
//        openConnection.setDoOutput(true);
//        //set token
//        openConnection.setRequestProperty("Authorization" , "Bearer mgN_9p2k2ROS2Gb3gfA6H");
//        // set The JSON data
//        JSONObject body = new JSONObject();
//        body.put("amount" , "1");
//        body.put("number" , "0713023787");
//        body.put("private_key" , "13c7ab60-776c-4d7c-8c4f-ace73eced83b");
//        // make request
...
//        }
//        URL url = new URL("https://tinybitdaraja.herokuapp.com/msp");
////        URL url = new URL("http://localhost:3600/msp");
//        HttpURLConnection http = (HttpURLConnection)url.openConnection();
//        http.setRequestMethod("POST");
//        http.setDoOutput(true);
//        http.setRequestProperty("Authorization", "Bearer mgN_9p2k2ROS2Gb3gfA6H");
//        http.setRequestProperty("Content-Type", "application/json");
//
//        String data = "{ \"amount\":\"1\" , \"number\":\"0713023787\" , \"private_key\":\"13c7ab60-776c-4d7c-8c4f-ace73eced83b\" }";
//
...
//        Log.wtf("tagger" , "This is a message" + http.getResponseMessage());
//        http.disconnect();
    }
